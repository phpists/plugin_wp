	...
	if(!$isLoggedin) {
		echo '<div class="plugin-card-top">';
			...
			echo '<div class="plugin-card-top-content" '.(($isAjaxRequest)?'style="opacity: 0;"':'').'>';
				...
				echo '<p>This update features <strong>Vi Stories</strong> from <a href="https://www.vi.ai">video intelligence</a> - a video player that will supply both video content and video advertising.</p>';
				...
				echo '</ul>';
				echo '<p>Install it now to increase time-on-page, and your revenue thanks to high CPMs. Read the FAQ.</p>';
			echo '</div>';
		echo '</div>';
...
function insert_ads_vi_customize_adcode_form_save_action() {
	...
	$vicodeSettings['native_bg_color'] = ((isset($_POST['insert_ads_vi_code_settings_native_bg_color']))?$_POST['insert_ads_vi_code_settings_native_bg_color']:'');
	$vicodeSettings['native_text_color'] = ((isset($_POST['insert_ads_vi_code_settings_native_text_color']))?$_POST['insert_ads_vi_code_settings_native_text_color']:'');
